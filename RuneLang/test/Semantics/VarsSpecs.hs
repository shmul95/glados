  ...
  Program
    ...
    [ DefFunction
      ...
      DefFunction
        ...
        TypeI32
        [ StmtVarDecl dummyPos "local" (Just (TypeArray TypeI32)) (ExprLitArray dummyPos [ExprVar dummyPos "arg"]),
          StmtExpr dummyPos (ExprCall dummyPos "bar" [ExprVar dummyPos "arg"]),
  ...
  Program
    ...
    [ DefFunction
        ...
        [ StmtVarDecl dummyPos "i" (Just TypeI32) (ExprLitInt dummyPos 42),
          ...
          StmtVarDecl dummyPos "c" (Just TypeChar) (ExprLitChar dummyPos 'a'),
