...
forEachArrayProgram = Program "fe-arr"
  [DefFunction "f" [Parameter "a" (TypeArray TypeI32) False] TypeNull
    [StmtForEach dummyPos "x" Nothing (ExprVar dummyPos "a") []]
    False]

forEachAnyProgram :: Program
forEachAnyProgram = Program "feany"
  [DefFunction "f" [Parameter "a" TypeAny False] TypeNull
    [StmtForEach dummyPos "x" Nothing (ExprVar dummyPos "a") []]
    False]
...
structAssignmentProgram = Program "assign"
  [DefStruct "S" [Field "x" TypeI32] [],
   DefFunction "f" [Parameter "s" (TypeCustom "S") False] TypeNull
...
arrayIndexProgram = Program "idx"
  [DefFunction "f" [Parameter "a" (TypeArray TypeI32) False] TypeI32
...
arrayIndexVarProgram = Program "aidx"
  [DefFunction "f" [Parameter "a" (TypeArray TypeI32) False, Parameter "i" TypeI32 False] TypeI32
...
structAccessProgram = Program "struct-access"
  [DefStruct "S" [Field "x" TypeI32] [],
   DefFunction "f" [Parameter "s" (TypeCustom "S") False] TypeI32
...
methodNoSelfProgram = Program "method-wrong-first"
  [DefStruct "S" []
    [DefFunction "f" [Parameter "x" TypeI32 False] TypeNull [] False]]

methodWrongFirstParamProgram :: Program
methodWrongFirstParamProgram = Program "method-wrong-first"
  [DefStruct "S" []
    [DefFunction "f" [Parameter "notself" TypeI32 False] TypeNull [] False]]
...
methodCallProgram = Program "method-call"
  [DefStruct "S" []
    [DefFunction "f" [Parameter "self" TypeAny False] TypeNull [] False],
...
methodCallWithArgsProgram = Program "method-call-args"
  [DefStruct "S" []
    [DefFunction "set" [Parameter "self" TypeAny False, Parameter "val" TypeI32 False] TypeNull [] False],
   DefFunction "main" [] TypeNull
    [StmtVarDecl dummyPos "s" Nothing (ExprStructInit dummyPos "S" []),
...
methodCallReturnProgram = Program "method-call-ret"
  [DefStruct "S" [Field "x" TypeI32]
    [DefFunction "get" [Parameter "self" TypeAny False] TypeI32 [StmtReturn dummyPos (Just (ExprAccess dummyPos (ExprVar dummyPos "self") "x"))] False],
   DefFunction "main" [] TypeNull
...
methodWithBodyProgram = Program "method-body"
  [DefStruct "S" [Field "x" TypeI32]
    [DefFunction "inc" [Parameter "self" TypeAny False] TypeNull
...
genericInstArgProgram = Program "gen"
  [DefFunction "id" [Parameter "x" TypeAny False] TypeAny [StmtReturn dummyPos (Just (ExprVar dummyPos "x"))] False,
...
testMangleFuncStack = do
  let fs = HM.fromList [("i32_f_i32", (TypeI32, [TypeI32], Nothing, False)), ("f32_f_f32", (TypeF32, [TypeF32], Nothing, False))]
